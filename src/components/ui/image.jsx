import {  getPlaceholder,  sdk, STATIC_MEDIA_URL } from '@wix/image-kit'
...
const getImageData = (url, imageProps) => {
...
const ImageWrapper = forwardRef(({ data, className, style, children }, ref) => {
...
const WixImage = forwardRef(
  ({ data, fittingType = 'fill', className, style, ...props }, parentRef) => {
    ...
    useImperativeHandle(parentRef, () => imgRef.current)
    ...
    if (size) {
      ...
      imgProps.style = placeholder.css.img 
