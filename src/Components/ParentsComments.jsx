...
export default function ParentsComments() {
   const comments=[{
      ...
      country:'Kenya'},
      {name:"Chinedu Okafor",
      comment:"My daughter used to be shy, but since she joined codingscholar, she's full of ideas and confidence. She talks about loops and logic like a little engineer!",
      img:parent1,
      country:'Nigeria'},
      {name:"Lerato Mokoena",
             ...
             {comments.map((item,i)=>{
               ...
               <div key={i} className='parentsCommentsCard'>
                   <div className='parentDetailsHolder'>
                     ...
                     <img loading="lazy" src={item.img} alt='Kids learning coding online in Kenya'/>
                     </div>
