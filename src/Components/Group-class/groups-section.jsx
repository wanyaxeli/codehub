...
// {message: 'Class group successfully created'}
      if (savedgroup.message=== 'Class group successfully created'){
        ...
        console.error('error in creating the group',savedgroup)
      }
  ...
  return (
    <div>
                ...
                <div className="paginations flex items-center justify-between border-t border-slate-700">
                  ...
                  <div className="flex gap-2 ">
                    <button
                      ...
                      className="pagination-btn !text-gray-800 hover:!text-blue-400"
                    >
                    ...
                    <button
                      ...
                      className="pagination-btn !text-blue-800  hover:!text-blue-400"
                    >
                      Next
     ...
     <ConfirmationModal
        ...
        description={`You are about to create the group "${groupName}". Do you wish to proceed?`}
