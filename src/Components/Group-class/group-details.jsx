    ...
    return(
        <div>
            <div className="group-container">
                ...
                <button
                onClick={onBack}
                 className="group-header !py-1 !px-2 rounded-md flex items-center text-cyan-400 hover:text-cyan-300 transition-colors" >
                    ...
                    <div className="flex items-center  gap-3 flex-1">
                       { isEditingName?(
                        <div className="marginbottom-two flex gap-2 flex-1">
                            ...
                            <button className="padding-two !p-2 !bg-white hover:!bg-cyan-700 rounded-lg items-center justify-center flex"
                        ...
                        className="padding-two items-center hover:!bg-slate-700 !bg-transparent  transition-colors">
                            <Edit2 className="w-6 h-6 cursor-pointer text-slate-400 hover:text-cyan-400"/>
