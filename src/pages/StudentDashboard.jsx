  ...
  return (
    <div className='StudentDashboardWrapper'>
        ...
        <aside className='flex flex-col bg-green-300 !text-black'>
          ...
          {/* ---- Referral card ---- */}
          <div className="!mx-3 !mt-4 !mb-3 overflow-hidden rounded-2xl border" style={{ borderColor: '#EAECF0', background: 'linear-gradient(160deg, #FFFFFF 0%, #F0FBFC 100%)' }}>

  {/* playful header strip */}
  <div className="relative !px-3 !py-2.5" style={{ background: 'linear-gradient(120deg, #0097B2 0%, #00B4D1 100%)' }}>
